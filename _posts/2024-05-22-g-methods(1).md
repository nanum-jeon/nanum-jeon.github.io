...
<a href="#" onclick="toggle_visibility(event, 'pub1');">[Empirical Settings]</a>
...
The g-formula can be used to estimate the average outcome level that would be observed in the population (that is, marginal outcome^[2]) under a hypotetical treatment intervention.  
